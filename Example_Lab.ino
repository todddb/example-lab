...
const char* wifiSSID = "-WIFI SSID-"; // In order for this to work, you MUST specify the SSID for your wifi
const char* wifiPSK  = "-WIFI PSK- "; // And the preshared key (wifi password)
